...
public class ProductSearchResultsRecyclerViewAdapter extends RecyclerView.Adapter<ProductListViewHolder> {
    ...
    public ProductListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewtype) {
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_view_item_product_search, parent, false);
    ...
    public ProductSearchResultsRecyclerViewAdapter(Context context, List<Product> productList, View productView, EmployeeTransition employeeTransition) {
        this.context = context;
